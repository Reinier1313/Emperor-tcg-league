              ...
              <div className="h-[55%] bg-primary relative overflow-hidden">
                ...
                <div className="absolute top-4 left-10">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[8px] text-primary-foreground/50 uppercase">QR Zone</span>
                  </div>
                </div>
                ...
                <div className="absolute inset-0 flex items-center justify-center pt-2">
                  <div className="text-center">
                    {/* EMPEROR text with Pokemon-style gradient look */}
                    <h1 className="text-3xl md:text-4xl font-black tracking-wider">
                      <span className="text-amber-400 drop-shadow-[2px_2px_0px_#1e40af]">EMPEROR</span>
                    </h1>
                    {/* TCG League with pokeballs */}
                    <div className="flex items-center justify-center gap-2 mt-0.5">
                      <PokeballBadge earned={true} size="sm" />
                      <span className="text-lg font-bold text-cyan-400 italic drop-shadow-[1px_1px_0px_#1e40af]">
                        TCG League
                      </span>
                      <PokeballBadge earned={true} size="sm" />
                    </div>
                    <p className="text-[10px] text-primary-foreground/60 mt-1 tracking-widest">
                      1ST EDITION
                    </p>
                  </div>
                </div>
